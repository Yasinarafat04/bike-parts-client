    ...
    return (
        <div>
            <div className="drawer drawer-mobile ">
                ...
                <div className="drawer-content flex flex-col items-start justify-items-start p-5">
                ...
                <div className="drawer-side border">
                    ...
                    <ul className="menu pl-4 overflow-y-auto w-64 bg-base-100 text-base-content">
                        ...
                        <li><NavLink className='border-r-2 mt-2 border-primary' to='products'>Products</NavLink></li>
